...
import { IonItem, IonContent, IonModal, IonHeader, IonToolbar, IonButtons, IonButton, IonBackButton } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [IonButtons, IonToolbar, IonHeader,IonContent ,IonModal, IonBackButton, IonButton ,IonItem, MatButtonModule,
...
export class ClientesComponent  implements OnInit {
  ...
  constructor(private router: Router, public clientes: ClientesService, public _FormBuilder: FormBuilder,
    public serviceOrganization: OrganizationService, private navController: NavController) {}

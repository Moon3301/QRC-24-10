...
@Component({
  ...
  imports: [MatListModule, MatDividerModule, MatIconModule, DatePipe, CommonModule, MatButtonModule, IonicModule]
})
export class DocumentosComponent  implements OnInit {
  ...
  constructor(private documentsService:DocumentsService, private navController: NavController) { }
